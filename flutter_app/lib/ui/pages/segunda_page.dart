...
import 'package:flutter_app/ui/pages/tercer_page.dart';
...
class _FormFieldsState extends State<FormFields> {
  ...
  void _submitForm() { // Validaciones al enviar el formulario
    if (_genero == '' || _genero.isEmpty) {
      _showSnackbar('Seleccione un género');
    }

    if (_paisSeleccionado == '' || _paisSeleccionado.isEmpty) {
      _showSnackbar('Seleccione un país');
    }

    if (_formKey.currentState!.validate()) { // evento de validación del formulario - si es válido con key del formulario con correctamente validado
      final nombre = _nombreController.text;
      final apellido = _apellidoController.text;
      
      _showSnackbar('Formulario enviado: $nombre $apellido');
      // Navegacion a tercera pagina
      Navigator.push(
        context, 
        MaterialPageRoute(builder: (context) => const TercerPage(),
      )
    );
    } else {
      _showSnackbar('Por favor completa los campos');
    }
  }
      ...
      // child: ListView( // ListView para permitir el desplazamiento de los widgets - SCROLL pero menos eficiente
        children: [
          TextFormField(
            ...
            validator: (value) { // Validar el campo de texto
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                TextButton(
                  onPressed: () {},
                  child: const Text('Primer boton')
                ),
                const SizedBox(width: 20),
                OutlinedButton(
                  onPressed: () {},
                  child: const Text('Segundo boton')
                ),
                const SizedBox(width: 20),
                ElevatedButton(
                  onPressed: () {},
                  child: const Text('Tercer boton')
                ),
                const SizedBox(width: 20),
                IconButton(
                  onPressed: () {},
                ...
                GestureDetector(
                  ...
                  onTap: () {
                    _showSnackbar('Cuarto boton presionado simple');
                    Navigator.pushNamed(context, '/cuarta');
                  },
                  onDoubleTap: () {
                    _showSnackbar('Cuarto boton presionado doble');
                  },
                  onLongPress: () {
                    _showSnackbar('Cuarto boton presionado largo');
